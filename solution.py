...
class SOLUTION:
    ...
    def Generate_Body(self):
        ...
        pyrosim.Send_Joint(name = "LThigh_LShank", parent= "LThigh", child = "LShank", type = "revolute", position = [0, 0, -0.6], jointAxis = "0 1 0")
        ...
        pyrosim.Send_Joint(name = "RThigh_RShank", parent= "RThigh", child = "RShank", type = "revolute", position = [0, 0, -0.6], jointAxis = "0 1 0")
